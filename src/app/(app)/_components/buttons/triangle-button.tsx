...
export default function TriangleButton({
  ...
  return (
    <Button
      size='icon'
      className={cn(
        'flex size-10 items-center rounded-full bg-primary p-0 drop-shadow-md transition active:scale-105 focus:scale-110 hover:scale-110 text-black focus-visible:ring-0',
        className,
      )}
      onClick={onClick}
      {...props}
